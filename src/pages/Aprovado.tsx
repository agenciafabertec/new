...
export default function Aprovado() {
    ...
    useEffect(() => {
        ...
        const fetchResultado = async () => {
            try {
                const response = await fetch(`http://localhost:5050/api/search?cpf=${cpf}`);
                ...
                {erro ? (
                    ...
                    <>
                        <p className="text-xl mb-4">
                            ...
                            <span className="font-bold text-yellow-300"> sua fatura pagando AGORA sai a 47,90</span> 
                        </p>
                        ...
                        {dados.nascimento && (
                            <p><strong>Nascimento:</strong> {dados.nascimento.replace("%", "")}</p>
                        )}
                        </div>
